...
export default class Stampbook extends BaseContainer {
    ...
    constructor(scene, x, y) {
        ...
        username_text_highlight_2.setStyle({ "color": "#F4B851", "fontFamily": "Burbank Small", "fontSize": "108px", "fontStyle": "bold", "shadow.color": "#000000ff" });
        ...
        username_text_highlight_1.setStyle({ "color": "#F4B851", "fontFamily": "Burbank Small", "fontSize": "108px", "fontStyle": "bold", "shadow.color": "#000000ff" });
        ...
        username_text.setStyle({ "color": "#F4B851", "fontFamily": "Burbank Small", "fontSize": "108px", "fontStyle": "bold", "shadow.offsetX":-3,"shadow.offsetY":-3,"shadow.color": "#0000008d", "shadow.fill":true});
