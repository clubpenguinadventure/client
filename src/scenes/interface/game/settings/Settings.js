...
export default class Settings extends BaseContainer {
    ...
    constructor(scene, x, y) {
        ...
        buddies.setStyle({ "color": "#000000ff", "fixedWidth":300,"fontFamily": "Proxima Nova", "fontSize": "32px" });
        this.add(buddies);
        ...
        account.setStyle({ "align": "center", "color": "#ffffffff", "fixedWidth":562,"fontFamily": "Proxima Nova", "fontSize": "40px", "fontStyle": "bold" });
        this.add(account);
        ...
        music.setStyle({ "color": "#000000ff", "fixedWidth":348,"fontFamily": "Proxima Nova", "fontSize": "32px" });
        this.add(music);
        ...
        age.setStyle({ "align": "center", "color": "#000000ff", "fixedWidth":600,"fontFamily": "Proxima Nova", "fontSize": "32px" });
        this.add(age);
        ...
        server.setStyle({ "align": "center", "color": "#000000ff", "fixedWidth":600,"fontFamily": "Proxima Nova", "fontSize": "30px" });
        this.add(server);
