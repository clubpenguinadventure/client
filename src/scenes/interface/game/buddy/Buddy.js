...
export default class Buddy extends BaseContainer {
    ...
    constructor(scene, x, y) {
        ...
        text.setStyle({ "align": "center", "color": "#000000", "fixedWidth":420,"fontFamily": "Proxima Nova", "fontSize": "32px" });
        this.add(text);
        ...
        total.setStyle({ "color": "#003366", "fixedWidth":100,"fixedHeight":64,"fontFamily": "Proxima Nova", "fontSize": "24px" });
        this.add(total);
