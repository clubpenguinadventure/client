...
export default class DualButtons extends BaseContainer {
    ...
    constructor(scene, x, y) {
        ...
        text_2.text = "No";
        text_2.setStyle({ "align": "center", "fixedWidth":150,"fontFamily": "Proxima Nova", "fontSize": "40px", "fontStyle": "bold" });
        this.add(text_2);
        ...
        text_1.text = "Yes";
        text_1.setStyle({ "align": "center", "fixedWidth":150,"fontFamily": "Proxima Nova", "fontSize": "40px", "fontStyle": "bold" });
        this.add(text_1);
