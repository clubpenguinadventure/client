...
export default class Checks extends BaseContainer {
    ...
    constructor(scene, x, y) {
        ...
        text_2.setStyle({ "align": "right", "color": "#000000ff", "fontFamily": "Proxima Nova", "fontSize": "30px" });
        ...
        text_1.setStyle({ "align": "right", "color": "#000000ff", "fontFamily": "Proxima Nova", "fontSize": "30px" });
