...
export default class Servers extends BaseScene {
    ...
    _create() {
        ...
        text_2.setStyle({ "fixedWidth":200,"fontFamily": "Proxima Nova", "fontSize": "28px" });
        ...
        text_1.setStyle({ "fixedWidth":300,"fontFamily": "Proxima Nova", "fontSize": "28px" });
        ...
        text.setStyle({ "fixedWidth":200,"fontFamily": "Proxima Nova", "fontSize": "28px" });
